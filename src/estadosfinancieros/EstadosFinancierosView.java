 ...
 */
public class EstadosFinancierosView extends FrameView {
    
    public EstadosFinancierosView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        estadosfinancieros.Cuenta c = new estadosfinancieros.Cuenta();
    ...
    public void deleteRecord() {
        ...
        List<estadosfinancieros.Cuenta> toRemove = new ArrayList<estadosfinancieros.Cuenta>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            estadosfinancieros.Cuenta c = list.get(selected[idx]);
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<estadosfinancieros.Cuenta> merged = new ArrayList<estadosfinancieros.Cuenta>(list.size());
                for (estadosfinancieros.Cuenta c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = EstadosFinancierosApp.getApplication().getMainFrame();
            aboutBox = new EstadosFinancierosAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        EstadosFinancierosApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(estadosfinancieros.EstadosFinancierosApp.class).getContext().getResourceMap(EstadosFinancierosView.class);
        ...
        tipoLabel.setText(resourceMap.getString("tipoLabel.text")); // NOI18N
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(estadosfinancieros.EstadosFinancierosApp.class).getContext().getActionMap(EstadosFinancierosView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                ...
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(tipoField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .add(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .add(mainPanelLayout.createSequentialGroup()
                ...
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(tipoLabel)
                    .add(tipoField, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(mainPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(saveButton)
                    .add(refreshButton)
    ...
    private java.util.List<estadosfinancieros.Cuenta> list;
